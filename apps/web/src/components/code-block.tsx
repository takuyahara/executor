  ...
  return (
    <div className={cn("group relative overflow-auto", className)}>
      ...
      <Button
        ...
        size="icon"
        onClick={handleCopy}
        className="absolute right-2 top-2 z-10 size-7 rounded-md border border-border bg-card/90 text-muted-foreground/40 opacity-0 backdrop-blur-sm transition-all hover:text-foreground group-hover:opacity-100"
